    ...
    return (
        <>
            ...
            <div>
                {" "}
                Video ID:{" "}
                <input type={"text"} value={video} onChange={onIdChange} />
            </div>
            <div>
                <span>Loop Start: </span>
                <button title="-1s" onClick={() => alterStartTime(-1)}>
                    ⏮️
                </button>
                <button title="-100ms" onClick={() => alterStartTime(-0.1)}>
                    ⏪
                </button>
                <input
                    type={"number"}
            ...
            <div>
                <span>Loop End: </span>
                <button title="-1s" onClick={() => alterEndTime(-1)}>
                    ⏮️
                </button>
                <button title="-100ms" onClick={() => alterEndTime(-0.1)}>
                    ⏪
                </button>
                <input
                    type={"number"}
...
export const BitPlayer = () => {
    return (
        <div className="BitPlayer">
            <header className="BitPlayer-header"></header>
            <Video />
        </div>
    )
}
