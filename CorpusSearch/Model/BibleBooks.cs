...
public static class BibleBooks
{
    ...
    [
        ...
        ("1-kings", "1 Kings", ["1 kgs", "1 kin", "1 kings", "1 reeaghyn"]),
        ("2-kings", "2 Kings", ["2 kgs", "2 kin", "2 reeaghyn"]),
        ("1-chronicles", "1 Chronicles", ["1 chron", "1 chr", "1 recortyssyn"]),
        ("2-chronicles", "2 Chronicles", ["2 chron", "2 chr", "2 recortyssyn"]),
        ("ezra", "Ezra", []),
        ("nehemiah", "Nehemiah", ["neh"]),
        ("esther", "Esther", ["esth"]),
        ("job", "Job", []),
        ("psalms", "Psalms", ["psalm", "psal", "ps", "psalmyn"]),
        ("proverbs", "Proverbs", ["prov", "raaghyn creeney"]),
        ...
        ("james", "James", ["jas", "screeuyn yamys"]),
